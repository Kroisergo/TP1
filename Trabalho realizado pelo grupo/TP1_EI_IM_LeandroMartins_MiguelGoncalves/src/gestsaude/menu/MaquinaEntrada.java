...
public class MaquinaEntrada extends javax.swing.JDialog {
	...
	private void validarConsulta() {
		...
		// FEITO verificar qual o utente, se existir, associado ao número introduzido
		Utente u = null;
		try {
		...
		// FEITO saber o nome do utente e ver qual a 1ª consulta do dia para este utente
		...
		// FEITO substituir texto pelo número da senha
